		...
		<div class="relative mx-auto w-full max-w-3xl rounded-[2.2rem] border border-white/70 bg-[#f6f4ef] px-6 py-10 shadow-[0_30px_70px_rgba(10,18,30,0.28)] sm:px-10 sm:py-12">
			...
			<div class="mx-auto max-w-xl">
				<div class="text-center">
					<h1 class="text-5xl font-black sm:text-6xl">Welcome!</h1>
					<p class="mt-3 text-lg leading-8 text-[color:var(--ns-ink)]">Create your NoteSpace account</p>
				</div>
				...
				<form class="auth-form" on:submit|preventDefault={handleSignup}>
					...
					<button type="submit" class="auth-submit btn btn-primary w-full">Sign Up</button>
				</form>

				<p class="mt-6 text-center text-base text-[color:var(--ns-ink)]">
					Already have an account?
					<a href="/auth/login" class="link link-primary ml-1 font-semibold">Log in</a>
				</p>
			</div>
		</div>
	</section>
